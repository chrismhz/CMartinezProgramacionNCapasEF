...
namespace DATOSXML
{
    public class Program
    {
        ...
        {
            //-------------------------------------- Para hacerlo mostrar por consola -----------------------------------------------------
            string ruta = @"C:\ejemplo\datos.xml"; // Declaracion de una variable entrada con la Ruta del archivo XML
            ...
            if (File.Exists(ruta)) // Verificar si el archivo datos.xml no existe
            {
                ...
                {                   
                    ...
                    Console.WriteLine("\nEl XML transformado se ha mostrado en la consola.");
                }
                catch (Exception ex)
                {
